...
if __name__ == '__main__':
    wts_ann_path = './data/WTS/annotations/caption/test/public_challenge'
    wts_bbox_path = './data/WTS/annotations/bbox_annotated/pedestrian/test/public'
    bdd_video_path = './data/BDD_PC_5K/videos/test'
    reference_view_path = './data/test_part/view_used_as_main_reference_for_multiview_scenario.csv'
    save_path = './data/test_part/best_view_for_test.json'
