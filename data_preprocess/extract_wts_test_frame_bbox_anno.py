...
video_path = os.path.join(args.root, 'WTS_DATASET_PUBLIC_TEST/videos/test/public')
annotation_path = os.path.join(args.root, 'WTS_DATASET_PUBLIC_TEST/annotations/caption/test/public_challenge')
bbox_path = os.path.join(args.root, 'WTS_DATASET_PUBLIC_TEST_BBOX/annotations/bbox_annotated/')
